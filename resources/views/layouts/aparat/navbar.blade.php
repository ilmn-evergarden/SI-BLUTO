<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="{{ route('aparat.dashboard') }}"><img src="{{ asset('images/logo.png') }}" class="mr-2" alt="logo" style="height:50px; width:auto;"/></a>
        <a class="navbar-brand brand-logo-mini" href="{{ route('aparat.dashboard') }}"><img src="{{ asset('images/logo-mini.png') }}"/></a>
      </div>
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <div id="navbar-clock-aparat" class="d-none d-md-flex align-items-center" style="
            margin-right: auto;
            margin-left: 8px;
        ...
        ">
            ...
            <div style="display: flex; align-items: center; gap: 6px; position: relative; z-index: 1;">
                ...
                <span id="clock-date-aparat" style="font-size: 0.8rem; font-weight: 500; letter-spacing: 0.3px; white-space: nowrap;"></span>
            </div>
            ...
            {{-- Clock icon + Time --}}
            <div style="display: flex; align-items: center; gap: 6px; position: relative; z-index: 1;">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="opacity: 0.9; flex-shrink: 0; animation: clockPulse 2s ease-in-out infinite;">
                    <circle cx="12" cy="12" r="10"></circle>
                    <polyline points="12 6 12 12 16 14"></polyline>
                </svg>
                <span id="clock-time-aparat" style="font-size: 0.85rem; font-weight: 700; letter-spacing: 1px; font-variant-numeric: tabular-nums; white-space: nowrap;"></span>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateClockAparat() {
        ...
        const dateEl = document.getElementById('clock-date-aparat');
        const timeEl = document.getElementById('clock-time-aparat');
    ...
    updateClockAparat();
    setInterval(updateClockAparat, 1000);
});
</script>